...
class Meal(models.Model):
    name = models.CharField(max_length=64)
    meal_type = models.ForeignKey(MealType, on_delete=models.CASCADE, related_name="types")
...
class MenuItem(models.Model):
    ...
    meal_size = models.ForeignKey(MealSize, on_delete=models.CASCADE, related_name="sizes", blank=True, null=True)
...
class OrderItem(models.Model):
    ...
    menu_item = models.ForeignKey(MenuItem, on_delete=models.CASCADE, related_name="order_menu_item")
